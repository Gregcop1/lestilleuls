...
class Grayscale_Original implements PaletteInterface
{
    /**
     * @var ColorParser
     */
 ...
 * 
 */
class Grayscale extends Grayscale_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
		...
		$this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			'profile' => array(
				'TYPO3\Flow\Aop\Advice\AroundAdvice' => array(
					new \TYPO3\Flow\Aop\Advice\AroundAdvice('TYPO3\Imagine\Aspect\PaletteInterfaceAspect', 'profileGrayscaleAspect', $objectManager, NULL),
				),
			),
		);
	}
	 ...
	 public function profile() {
		...
		$result = parent::profile();
			...
			try {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'Imagine\Image\Palette\Grayscale', 'profile', $methodArguments, $adviceChain);
	...
	$reflectedClass = new \ReflectionClass('Imagine\Image\Palette\Grayscale');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('Imagine\Image\Palette\Grayscale', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('Imagine\Image\Palette\Grayscale', $propertyName, 'var');
