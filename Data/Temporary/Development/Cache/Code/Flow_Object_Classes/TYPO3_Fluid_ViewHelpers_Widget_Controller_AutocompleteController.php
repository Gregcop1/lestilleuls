 ...
 * Controller for the auto-complete widget
 */
class AutocompleteController extends AutocompleteController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if ('TYPO3\Fluid\ViewHelpers\Widget\Controller\AutocompleteController' === get_class($this)) {
	 ...
	 public function indexAction() {
		...
		$result = parent::indexAction();
			...
			try {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\ViewHelpers\Widget\Controller\AutocompleteController', 'indexAction', $methodArguments, $adviceChain);
	 ...
	 public function autocompleteAction($term) {
		...
		$result = parent::autocompleteAction($term);
			...
			try {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\ViewHelpers\Widget\Controller\AutocompleteController', 'autocompleteAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\ViewHelpers\Widget\Controller\AutocompleteController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Fluid\ViewHelpers\Widget\Controller\AutocompleteController', $propertyName, 'var');
