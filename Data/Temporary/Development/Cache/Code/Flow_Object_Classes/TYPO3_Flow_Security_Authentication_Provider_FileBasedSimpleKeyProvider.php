...
class FileBasedSimpleKeyProvider extends FileBasedSimpleKeyProvider_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authentication\Provider\FileBasedSimpleKeyProvider', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
