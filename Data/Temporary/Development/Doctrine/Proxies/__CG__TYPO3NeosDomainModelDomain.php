 ...
 */
class Domain extends \TYPO3\Neos\Domain\Model\Domain implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setHostPattern($hostPattern);
    }

    public function getHostPattern()
    {
        $this->__load();
        return parent::getHostPattern();
    }
