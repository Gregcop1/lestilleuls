...
class RouterCachingService extends RouterCachingService_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
		...
		$this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			'extractUuids' => array(
				'TYPO3\Flow\Aop\Advice\BeforeAdvice' => array(
					new \TYPO3\Flow\Aop\Advice\BeforeAdvice('TYPO3\Neos\Routing\Aspects\RouteCacheAspect', 'addCurrentNodeIdentifier', $objectManager, NULL),
				),
			),
		);
	}
	 ...
	 protected function extractUuids(array $values) {
		...
		$result = parent::extractUuids($values);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['extractUuids']['TYPO3\Flow\Aop\Advice\BeforeAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['extractUuids']['TYPO3\Flow\Aop\Advice\BeforeAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\Routing\RouterCachingService', 'extractUuids', $methodArguments);
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Mvc\Routing\RouterCachingService', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
