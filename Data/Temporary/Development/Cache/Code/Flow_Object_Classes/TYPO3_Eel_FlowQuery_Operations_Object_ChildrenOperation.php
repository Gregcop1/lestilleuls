...
class ChildrenOperation extends ChildrenOperation_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Eel\FlowQuery\Operations\Object\ChildrenOperation', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
