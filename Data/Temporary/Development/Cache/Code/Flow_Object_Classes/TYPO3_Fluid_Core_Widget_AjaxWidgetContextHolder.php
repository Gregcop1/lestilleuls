...
class AjaxWidgetContextHolder extends AjaxWidgetContextHolder_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 public function store(\TYPO3\Fluid\Core\Widget\WidgetContext $widgetContext) {
		...
		$result = parent::store($widgetContext);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['store']['TYPO3\Flow\Aop\Advice\BeforeAdvice'])) {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', 'store', $methodArguments, $adviceChain);
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', $propertyName, 'var');
