...
class StandardController extends StandardController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 public function indexAction() {
		...
		$result = parent::indexAction();
			...
			try {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\Controller\StandardController', 'indexAction', $methodArguments, $adviceChain);
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Mvc\Controller\StandardController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
