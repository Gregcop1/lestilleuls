...
class Role extends Role_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface, \TYPO3\Flow\Persistence\Aspect\PersistenceMagicInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\Flow\Security\Policy\Role') {
		...
		$result = NULL;
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['__clone']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Policy\Role', '__clone', $methodArguments, NULL, $result);
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Policy\Role', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
