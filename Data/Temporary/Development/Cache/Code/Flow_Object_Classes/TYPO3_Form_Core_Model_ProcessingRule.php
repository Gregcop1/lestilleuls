 ...
 * **This class is not meant to be subclassed by developers.**
 */
class ProcessingRule extends ProcessingRule_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		parent::__construct();
		if ('TYPO3\Form\Core\Model\ProcessingRule' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Form\Core\Model\ProcessingRule');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Form\Core\Model\ProcessingRule', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Form\Core\Model\ProcessingRule', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$this->validator = new \TYPO3\Flow\Validation\Validator\ConjunctionValidator(array (
));
...
$this->Flow_Injected_Properties = array (
  0 => 'propertyMappingConfiguration',
  1 => 'validator',
  2 => 'propertyMapper',
);
	}
