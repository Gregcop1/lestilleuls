...
class RenderViewHelper extends RenderViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Form\ViewHelpers\RenderViewHelper' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Form\ViewHelpers\RenderViewHelper');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Form\ViewHelpers\RenderViewHelper', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Form\ViewHelpers\RenderViewHelper', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$formPersistenceManager_reference = &$this->formPersistenceManager;
		$this->formPersistenceManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('TYPO3\Form\Persistence\FormPersistenceManagerInterface');
		if ($this->formPersistenceManager === NULL) {
			$this->formPersistenceManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('36ed4b877e041c3e15ddc2512adb460f', $formPersistenceManager_reference);
			if ($this->formPersistenceManager === NULL) {
				$this->formPersistenceManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('36ed4b877e041c3e15ddc2512adb460f',  $formPersistenceManager_reference, 'TYPO3\Form\Persistence\YamlPersistenceManager', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Form\Persistence\FormPersistenceManagerInterface'); });
			}
		}
