...
class PaginateController extends PaginateController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 public function indexAction($currentPage = 1) {
		...
		$result = parent::indexAction($currentPage);
			...
			try {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController', 'indexAction', $methodArguments, $adviceChain);
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		$this->injectSettings(\TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'TYPO3.Fluid'));
