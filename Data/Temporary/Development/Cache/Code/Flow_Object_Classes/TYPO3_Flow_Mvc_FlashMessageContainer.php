...
class FlashMessageContainer extends FlashMessageContainer_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 public function addMessage(\TYPO3\Flow\Error\Message $message) {
		...
		$result = parent::addMessage($message);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['addMessage']['TYPO3\Flow\Aop\Advice\BeforeAdvice'])) {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\FlashMessageContainer', 'addMessage', $methodArguments, $adviceChain);
	 ...
	 public function flush($severity = NULL) {
		...
		$result = parent::flush($severity);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['flush']['TYPO3\Flow\Aop\Advice\BeforeAdvice'])) {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\FlashMessageContainer', 'flush', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Mvc\FlashMessageContainer', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Flow\Mvc\FlashMessageContainer', $propertyName, 'var');
