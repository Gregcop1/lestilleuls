 ...
 */
class Typo3OrgSsoProvider_Original extends AbstractProvider {
 ...
 * An authentication provider that authenticates SSO requests from typo3.org
 */
class Typo3OrgSsoProvider extends Typo3OrgSsoProvider_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if ('TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider' === get_class($this)) {
	 ...
	 public function authenticate(\TYPO3\Flow\Security\Authentication\TokenInterface $authenticationToken) {
		...
		$result = parent::authenticate($authenticationToken);
			...
			try {
				...
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider', 'authenticate', $methodArguments);
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['authenticate']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider', 'authenticate', $methodArguments, NULL, $result);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$this->rsaWalletService = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('TYPO3\Flow\Security\Cryptography\RsaWalletServiceInterface');
		if ($this->rsaWalletService === NULL) {
			$this->rsaWalletService = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('90530581c7c9a5028286b98093996c7e', $rsaWalletService_reference);
			if ($this->rsaWalletService === NULL) {
				$this->rsaWalletService = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('90530581c7c9a5028286b98093996c7e',  $rsaWalletService_reference, 'TYPO3\Flow\Security\Cryptography\RsaWalletServicePhp', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Security\Cryptography\RsaWalletServiceInterface'); });
			}
		}
