...
class Node extends Node_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 protected function emitNodeAdded(\TYPO3\TYPO3CR\Domain\Model\NodeInterface $node) {
		...
		$result = parent::emitNodeAdded($node);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeAdded']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeAdded']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Node', 'emitNodeAdded', $methodArguments, NULL, $result);
	 ...
	 protected function emitNodeUpdated(\TYPO3\TYPO3CR\Domain\Model\NodeInterface $node) {
		...
		$result = parent::emitNodeUpdated($node);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeUpdated']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeUpdated']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Node', 'emitNodeUpdated', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	 ...
	 protected function emitNodeRemoved(\TYPO3\TYPO3CR\Domain\Model\NodeInterface $node) {
		...
		$result = parent::emitNodeRemoved($node);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeRemoved']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodeRemoved']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Node', 'emitNodeRemoved', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	 ...
	 * @\TYPO3\Flow\Annotations\Signal
	 */
	 protected function emitNodePropertyChanged(\TYPO3\TYPO3CR\Domain\Model\NodeInterface $node, $propertyName, $oldValue, $newValue) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePropertyChanged'])) {
		$result = parent::emitNodePropertyChanged($node, $propertyName, $oldValue, $newValue);

		} else {
			$this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePropertyChanged'] = TRUE;
			try {
				...
				$methodArguments['oldValue'] = $oldValue;
				$methodArguments['newValue'] = $newValue;
			
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Node', 'emitNodePropertyChanged', $methodArguments);
				$result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePropertyChanged']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitNodePropertyChanged']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\TYPO3CR\Domain\Model\Node', 'emitNodePropertyChanged', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				...
				unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePropertyChanged']);
				throw $e;
			}
			unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitNodePropertyChanged']);
		}
