...
class AccessDecisionVoterManager extends AccessDecisionVoterManager_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 public function decideOnJoinPoint(\TYPO3\Flow\Aop\JoinPointInterface $joinPoint) {
		...
		try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['decideOnJoinPoint']['TYPO3\Flow\Aop\Advice\AfterThrowingAdvice'])) {
					$advices =  $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['decideOnJoinPoint']['TYPO3\Flow\Aop\Advice\AfterThrowingAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authorization\AccessDecisionVoterManager', 'decideOnJoinPoint', $methodArguments, NULL, NULL, $exception);
	 ...
	 */
	 public function decideOnResource($resource) {
		...
		try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['decideOnResource']['TYPO3\Flow\Aop\Advice\AfterThrowingAdvice'])) {
					$advices =  $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['decideOnResource']['TYPO3\Flow\Aop\Advice\AfterThrowingAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authorization\AccessDecisionVoterManager', 'decideOnResource', $methodArguments, NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authorization\AccessDecisionVoterManager', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Flow\Security\Authorization\AccessDecisionVoterManager', $propertyName, 'var');
